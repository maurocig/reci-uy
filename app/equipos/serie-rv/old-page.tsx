...
export default function SerieRvPage({}: SerieRvPageProps) {
  ...
  return (
    <div className="grid gap-4 grid-cols lg:gap-6">
      <div
        style={{ backgroundImage: `url(/images/serie-rv-billboard.jpg)` }}
      ...
      <div className="grid w-full grid-cols-1 gap-4 lg:gap-6 lg:grid-cols-2 xl:grid-cols-3 ">
        ...
        <Box className="flex flex-col col-span-1 gap-3 lg:order-2 xl:col-span-2 ">
          ...
          <p className="hidden">
            La serie ofrece la solución ideal para aquellos operadores que
            transportan mercancía sensible a la temperatura en vehículos de
            pequeño y mediano tamaño.
          </p>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci
            culpa facere pariatur cum, repudiandae, dignissimos at provident
            corporis deleniti labore necessitatibus iusto quos et corrupti.
            Dolore ratione neque repellendus consequuntur.
          </p>
          <p>
